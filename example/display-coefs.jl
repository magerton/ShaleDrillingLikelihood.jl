...
nms, coef, se, sumstats = nms_coef_se_sumstat(JLD2FILE)
...
add_drilling_heading(textable)   = replace(textable, r"(\n +\$ *\\alpha\_0 *\$)" => s" & \\multicolumn{4}{c}{\\emph{Drilling}  } \\\\ \\addlinespace[1pt]\1")
...
pth = "C:/Users/magerton/Desktop/test-table.tex"
...
io = open(pth, "w")
    ...
    write(io, make_table(regtable(rcnew, rcnew), "caption", "label", "note");   write(io, "\n\n\n\n\n")
close(io)
