function _precompile_()
    ...
    @assert precompile(Tuple{Core.kwftype(typeof(ShaleDrillingLikelihood.start_up_workers)),NamedTuple{(:nprocs,),Tuple{Int64}},typeof(start_up_workers),Base.EnvDict})
